...
BOT_TOKEN    = "8565204943:AAHxmBVVHcEXYqtb32dyVCbCiUb740NDIOo"
BOT_USERNAME = "@AcepterXRobot"
...
LOG_CHANNEL_ID   = -1004322906658
LOG_CHANNEL_LINK = "https://t.me/logsb4"

ALLOWED_GROUP_USERNAME = "FelixArmy"
GROUP_LINK             = "https://t.me/FelixArmy"
GROUP_NAME             = "Felix Chat Group"
...
def _seed_default_channels():
    ...
    if _col_channels.count_documents({}) == 0:
        _col_channels.insert_many([
            {"name": "Felix Modz1", "type": "channel", "username": "@Felix_modz1", "link": "https://t.me/Felix_modz1", "chat_id": None},
            {"name": "Felix Army",  "type": "group",   "username": "@FelixArmy",    "link": "https://t.me/FelixArmy",    "chat_id": None},
        ])
...
def _build_welcome_template():
    ...
    _WELCOME_HTML_GENERIC = (
        ...
        f"{_LOOP_SINGLE * 10}\n"
        f"{_te(_E_DEV,'👨‍💻')} ᴅᴇᴠ : @Felix_bhai {_te(_E_CHECK,'✅')}"
        f"</blockquote>"
    )
...
def get_welcome_buttons():
    ...
    mk.add(SBtn("ᴜꜱᴇ ʜᴇʀᴇ", style="primary",  icon_custom_emoji_id="6257944590687410044", url="https://t.me/FelixArmy"))
    mk.row(
        SBtn("ᴏᴡɴᴇʀ", style="primary",  icon_custom_emoji_id="5427328491513224187", url="https://t.me/Felix_bhai"),
        SBtn("ᴜᴩᴅᴀᴛᴇ", style="primary",  icon_custom_emoji_id="5260691173541970181", url="https://t.me/Felix_modz1"),
    )
    return mk
...
def is_allowed_group(chat_id, chat_username=""):
    if chat_username and chat_username.lower().lstrip("@") == ALLOWED_GROUP_USERNAME.lower():
        return True
